...
def dump_file(path, class_, module, field_names):
    ...
    Note: Fields that are autogenerated by the add_file function
    (SHA1 and other hashes, file size, etc) are not user-editable.
    They should be excluded from the CSV file.
    File.id contains the role and a fragment of the SHA1 hash
    so it is inserted in their place.
